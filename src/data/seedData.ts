...
export const SEED_NOTIFICATIONS: NotificationItem[] = [
  // Aria Montgomery (Student 1)
  {
    id: 'notif_std1_1',
    userId: 'usr_student_1',
    title: 'Certificate Awarded: Python Mastery',
    message: 'Congratulations Aria! You completed Python Programming with an outstanding 94% score.',
    type: 'CERTIFICATE',
    isRead: false,
  ...
  },
  {
    id: 'notif_std1_2',
    userId: 'usr_student_1',
    title: 'Doubt Resolved: Python Variables & Scope',
    message: 'Dr. Marcus Vance answered your inquiry about mutable defaults in Python functions.',
    type: 'COURSE',
    isRead: false,
  ...
  },
  {
    id: 'notif_std1_3',
    userId: 'usr_student_1',
    title: 'New Chapter Available: Machine Learning',
    message: 'Neural Networks & Deep Learning Foundations has been unlocked in your curriculum.',
    type: 'COURSE',
    isRead: true,
    createdAt: '2026-09-04T09:00:00Z',
    actionUrl: 'course_view',
  },
  ...
  // Leo Patel (Student 2)
  {
    ...
    message: 'Your assignment on Java Object-Oriented Polymorphism scored 92/100.',
    type: 'ASSESSMENT',
    isRead: false,
  ...
  },
  {
    id: 'notif_std2_2',
    userId: 'usr_student_2',
    title: 'Quiz Passed: Java Fundamentals',
    message: 'You scored 88% on Java Syntax & OOP Principles. Keep up the great work!',
    type: 'ASSESSMENT',
    isRead: false,
  ...
  // Sarah Lin (Student 3)
  {
    ...
    title: 'SQL Normalization Feedback',
    message: 'Dr. Elena Rostova endorsed your solution for 3NF to BCNF decomposition.',
    type: 'COURSE',
    isRead: false,
  ...
  // Dr. Marcus Vance (Instructor 1)
  {
    id: 'notif_inst1_1',
    userId: 'usr_instructor_1',
    title: 'New Student Doubts Assigned (2)',
    message: 'Students Aria Montgomery and Leo Patel submitted technical inquiries on Python & Java.',
    type: 'COURSE',
    isRead: false,
  ...
  },
  {
    id: 'notif_inst1_2',
    userId: 'usr_instructor_1',
    title: 'Assignment Submissions Ready for Review',
    message: '5 new student submissions are waiting in your Python & Java Grading Center.',
    type: 'ASSESSMENT',
    isRead: false,
  ...
  },
  {
    ...
    message: 'Administrator Cassian Thorne approved your updated Python 30-lesson syllabus.',
    type: 'SYSTEM',
    isRead: true,
  ...
  // Dr. Elena Rostova (Instructor 2)
  {
    id: 'notif_inst2_1',
    userId: 'usr_instructor_2',
    title: 'DBMS Student Inquiries Pending',
    message: 'A student requested guidance on ACID isolation levels and B+ tree indexing.',
    type: 'COURSE',
    isRead: false,
  ...
  },
  {
    id: 'notif_inst2_2',
    userId: 'usr_instructor_2',
    title: 'Midterm Quiz Results Available',
    message: '12 students have completed the DBMS & SQL Evaluation with an 89% average.',
    type: 'ASSESSMENT',
    isRead: false,
  ...
  // Cassian Thorne (System Administrator)
  {
    id: 'notif_admin_1',
    userId: 'usr_admin_1',
    title: 'Platform Audit: 100% Operational',
    message: 'All 4 course curricula, AI knowledge engine, and user session stores are synchronized.',
    type: 'SYSTEM',
    isRead: false,
    createdAt: '2026-09-07T07:00:00Z',
    actionUrl: 'audit_logs',
  },
  {
    id: 'notif_admin_2',
    userId: 'usr_admin_1',
    title: 'New Faculty Account Verified',
    message: 'Dr. Marcus Vance account permissions and instructor credentials confirmed.',
    type: 'SYSTEM',
    isRead: false,
  ...
  },
  {
    ...
    message: 'Zero secret leaks, verified 100% clean proprietary codebase with TrainPlex guardrails.',
    type: 'SYSTEM',
    isRead: true,
